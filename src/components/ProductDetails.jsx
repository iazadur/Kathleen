            ...
            <section class="text-gray-600 body-font overflow-hidden">
                <div class="container px-5 py-24 mx-auto">
                    <div class="lg:w-4/5 mx-auto flex flex-wrap ">
                        <div className=" flex gap-x-2 sm:flex-col lg:flex-row sm:w-full lg:w-1/2 ">
                            <div className="flex lg:flex-col sm:flex-row lg:w-2/12 sm:w-full gap-y-4 sm:order-1 lg:order-0 sm:gap-2 sm:my-3">
                                <img alt="ecommerce" class="lg:w-full sm:w-1/4 sm:h-auto lg:h-auto h-64 object-cover object-center rounded" src="https://dummyimage.com/100x100" />
                                <img alt="ecommerce" class="lg:w-full sm:w-1/4 sm:h-auto lg:h-auto h-64 object-cover object-center rounded" src="https://dummyimage.com/100x100" />
                                <img alt="ecommerce" class="lg:w-full sm:w-1/4 sm:h-auto lg:h-auto h-64 object-cover object-center rounded" src="https://dummyimage.com/100x100" />
                                <img alt="ecommerce" class="lg:w-full sm:w-1/4 sm:h-auto lg:h-auto h-64 object-cover object-center rounded" src="https://dummyimage.com/100x100" />
                            </div>
                            <img alt="ecommerce" class="sm:order-0 lg:order-1 w-full sm:h-auto lg:h-auto lg:w-10/12  h-64 object-cover object-center rounded" src="https://dummyimage.com/400x400" />
                        </div>
